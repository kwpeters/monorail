...
import { promisify0, promisify1, promisify2, promisify3, promisify4, promisify5 } from "./promisify.mjs";


describe("promisify0()", () => {
    function fn0Resolve(cb: (err?: Error, result?: number) => void): void {
        void getTimerPromise(10, undefined)
        .then(() => {
            cb(undefined, 4);
        });
    }
    ...
    it("when the returned function is invoke the promise rejects with the expected value", async () => {
        ...
        try {
            const __result = await promisified();
...
describe("promisify1()", () => {
    ...
    it("when the returned function is invoke the promise rejects with the expected value", async () => {
        ...
        try {
            const __result = await promisified(6);
            fail("Should not have resolved.");
        }
        catch (error) {
...
describe("promisify2()", () => {
    ...
    it("when the returned function is invoke the promise rejects with the expected value", async () => {
        ...
        try {
            const __result = await promisified(2, 4);
            fail("Should not have resolved.");
        }
        catch (error) {
...
describe("promisify3()", () => {
    ...
    it("when the returned function is invoke the promise rejects with the expected value", async () => {
        ...
        try {
            const __result = await promisified(2, 4, 1);
            fail("Should not have resolved.");
        }
        catch (error) {
...
describe("promisify4()", () => {
    ...
    it("when the returned function is invoke the promise rejects with the expected value", async () => {
        ...
        try {
            const __result = await promisified(2, 4, 1, 4);
            fail("Should not have resolved.");
        }
        catch (error) {
...
describe("promisify5()", () => {
    ...
    it("when the returned function is invoke the promise rejects with the expected value", async () => {
        ...
        try {
            const __result = await promisified(2, 4, 1, 4, 3);
            fail("Should not have resolved.");
        }
        catch (error) {
