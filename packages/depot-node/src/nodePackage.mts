...
import {gitUrlToProjectName} from "./gitHelpers.mjs";
import {getOs, OperatingSystem} from "./os.mjs";
import { addShebang, makeFileExecutable } from "./nodeUtil.mjs";
import { NodePackageScript } from "./nodePackageScript.mjs";
