import {BufBuilder} from "../src/bufBuilder.js";
...
describe("BufBuilder", () => {
    ...
    it("appendUInt64() can append a UInt64", () => {
        ...
        const ulint = Ulint.fromBuffer(Buffer.from([0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08])).value!;
    ...
    it("appendInt64() can append a Int64", () => {
        const lint = Lint.fromBuffer(Buffer.from([0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x88])).value!;
        const bb = new BufBuilder();
        bb.appendInt64(lint);
